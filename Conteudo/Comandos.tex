...
\begin{figure}[htb]
	...
	\begin{center}
	    \includegraphics[scale=1]{Imagens/adm-dieta-enteral.png}
	\end{center}
	\legend{Fonte: \citeonline[p. 18]{manual-paciente-hospitalizado}}
\end{figure}
...
\begin{figure}[htb]
 ...
 \centering
  ...
  \begin{minipage}{0.4\textwidth}
    ...
    \legend{Fonte: \citeonline[p. 24]{abntex2-wiki-como-customizar}}
  \end{minipage}
\end{figure}
